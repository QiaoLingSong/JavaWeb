...
/*CSS yahoo style www.divcss5.com */
DIV.yahoo {
PADDING-RIGHT: 3px; PADDING-LEFT: 3px; PADDING-BOTTOM: 3px; MARGIN: 3px; PADDING-TOP: 3px; TEXT-ALIGN: center
}
DIV.yahoo A {
...
/*CSS flickr style www.divcss5.com */
DIV.flickr {
PADDING-RIGHT: 3px; PADDING-LEFT: 3px; PADDING-BOTTOM: 3px; MARGIN: 3px; PADDING-TOP: 3px; TEXT-ALIGN: center
}
DIV.flickr A {
...
/*CSS sabrosus style http://www.divcss5.com */
DIV.sabrosus {
PADDING-RIGHT: 3px; PADDING-LEFT: 3px; PADDING-BOTTOM: 3px; MARGIN: 3px; PADDING-TOP: 3px; TEXT-ALIGN: center
}
DIV.sabrosus A {
...
/*CSS scott style www.divcss5.com */
DIV.scott {
PADDING-RIGHT: 3px; PADDING-LEFT: 3px; PADDING-BOTTOM: 3px; MARGIN: 3px; PADDING-TOP: 3px; TEXT-ALIGN: center
}
DIV.scott A {
...
/*CSS grayr style www.divcss5.com */
DIV.grayr {
...
/*CSS yellow style http://www.divcss5.com */
DIV.yellow {
PADDING-RIGHT: 7px; PADDING-LEFT: 7px; PADDING-BOTTOM: 7px; MARGIN: 3px; PADDING-TOP: 7px; TEXT-ALIGN: center
}
DIV.yellow A {
...
/*CSS jogger style http://www.divcss5.com/ */
DIV.jogger {
...
/*CSS youtube style www.divcss5.com */
DIV.youtube {
...
/*CSS yahoo2 style www.divcss5.com */
DIV.yahoo2 {
...
//接收到了pageNow
  pageNow=Integer.parseInt(s_pageNow);
   ...
   String driverName="com.mysql.cj.jdbc.Driver";//驱动程序名
    ...
    Connection conn = null;
      ...
      // 2. 链接数据库
      conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/students?useSSL=true&serverTimezone=UTC", userName, userPwd);
 ...
 if(pageNow>pageCount) 
   ...
   if(pageCount>0){ 
  //将记录指针定位到待显示页面 
     rs.absolute((pageNow-1)*pageSize); 
     }
  %>   
   <table class="altrowstable" id="alternatecolor">
<tr><td>用户ID</td><td>学生姓名</td><td>性别</td><td>年龄</td><td>身高</td><td>身高</td></tr>
<%
int j=0;
...
<td><%=rs.getString(3)%></td><td><%=rs.getString(4)%></td><td><%=rs.getString(5)%></td><td><%=rs.getString(6)%></td></tr>
<%j++;%>
<%}%>
</table>
...
//上一页
if(pageNow>1){
out.println("<a href=page.jsp?pageNow="+(pageNow-1)+">上一页</a>");
}
//显示超链接
for(int i=1;i<=pageCount;i++){
out.println("<a href=page.jsp?pageNow="+i+">["+i+"]</a>");
}
//下一页
if(pageNow!=pageCount){
out.println("<a href=page.jsp?pageNow="+(pageNow+1)+">下一页</a>");
}
%>
</div>
 <%  if(rs!=null)
